...
START:
    ...
    ADD AX,[SI+4] ;add contents of AX with the values to which SI+4 is pointing towards (Second Part of Second Number)
    ...
    ADC AX,[SI+6] ;add contents of AX with the values to which SI+4 is pointing towards (First Part of Second Number) -ADC Add with Carry
